...
# Install from CRAN Matzkes wrappers for FORTRAN EXPOKIT and C++ cladogenesis calculations
...
#######################################################
# R PACKAGES - PERHAPS HELPFUL, OR DISCARDED
#######################################################
optional_installs='
...
' # END optional_installs


# Load libraries
library(ape)
library(BioGeoBEARS)	# for cls.df, prt(), sourceall, etc.
...
# Nick's custom code:
sourceall("~/GitHub/str2phyw/Rsrc/")
